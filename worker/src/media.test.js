...
beforeEach(() => {
	...
	for (const file of ["0001_news.sql", "0002_gallery_quotes.sql", "0003_world_points_partners.sql", "0004_videos.sql", "0005_projects.sql"]) db.exec(readFileSync(new URL(`../migrations/${file}`, import.meta.url), "utf8"));
	objects = new Map();
