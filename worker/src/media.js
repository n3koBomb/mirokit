...
const MEDIA_KEY_PATTERN = /^(?:(?:news|gallery|partners|projects|video-posters)\/(?:pending\/)?[a-f0-9-]+\.(?:jpg|png|webp|avif)|videos\/(?:pending\/)?[a-f0-9-]+\.(?:mp4|webm|ogv)|subtitles\/(?:pending\/)?[a-z0-9-]+\.vtt)$/;
